...
// Toptal "Top 3% Talent" badge. Styles are scoped under #toptal-badge to
// avoid the original snippet's generic class names clashing with the page.
const BADGE_CSS = `
      ...
      <div className="h">
        <div className="a">
          ...
          <a
            ...
            className="f"
            href="https://www.toptal.com/developers/resume/calvin-kodian#q27Ox6"
          >
            Hire me
          </a>
        </div>
